...
export const getNewCowrieTokenContract = (chainId, web3) => {
  return getContract(bep20Abi, getNewCowrieAddress(chainId), web3)
}

export const getSwapContract = (chainId, web3) => {
  return getContract(swapAbi, getSwapContractAddress(chainId), web3)
}
